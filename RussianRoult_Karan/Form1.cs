...
namespace RussianRoult_Karan
{
    public partial class Form1 : Form
    {
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            count_Triger = 0;
            chance++;
            //if this is the frst chance update the label 
            if (chance==1) {
                label1.Text = "This is your second chance to play  ";
            }

            sound = obj_instance.fire();

            //if the last chance then the 
            if (chance==3)
            {
                label1.Text = "Your chances are over now ";
